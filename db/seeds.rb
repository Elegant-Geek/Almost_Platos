...
# ****************** FLASHION SEEDS FILE *******************
@yoda = User.create!(name: "Yoda", username: "Yoda", email: 'yoda@example.com', password: 'lightsaber', password_confirmation: 'lightsaber')
@luke = User.create!(name: "Luke", username: "Luke", email: 'luke@example.com', password: 'lightsaber', password_confirmation: 'lightsaber')

@yoda.items.create!([{
    name: 'Jedi Robes', stars: 5,
    description: %{Cool item this is!}.squish,
    found_on: "2021-02-26",
    brand: 'unknown',
  ...
  },
  {
    ...
    stars: 4,
    description:
    %{MMMmmmMM! for laundry day this robe is!}.squish,
    found_on: "2021-02-27",
    brand: 'unknown',
    image_file_name: 'placeholder-2.png',
    flair: 'Sold',
